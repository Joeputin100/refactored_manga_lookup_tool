...
def rasterize_unicode_character(character, font_size=200, image_size=256):
    ...
    # Try different font paths for Unicode support - prioritize working fonts
    font_paths = [
        os.path.join(current_dir, "fonts/DejaVuSans.ttf"),  # Primary Unicode font (working)
        os.path.join(current_dir, "fonts/LiberationSans-Regular.ttf"),  # Secondary Unicode font (working)
        os.path.join(current_dir, "fonts/NotoColorEmoji-Regular.ttf"),  # Emoji font (not working properly)
