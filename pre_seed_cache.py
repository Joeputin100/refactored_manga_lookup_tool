#!/usr/bin/env python3
"""
Comprehensive pre-seeding script for manga series cache
Populates BigQuery cache with series information, cover images, and volume data
"""
...
class CachePreSeeder:
    ...
    def process_series(self, series_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            series_info = self.manga_lookup.search_series(series_name)
            ...
            volumes_info = self.manga_lookup.get_volumes(series_name)
            self.stats['api_calls'] += 1
    ...
    def print_current_stats(self):
        ...
        progress = (self.stats['processed_series'] / self.stats['total_series']) * 100
