...
def query_deepseek_for_series_info(series_name):
    ...
    try:
        ...
        book_data = deepseek_api.get_book_info(corrected_name, 1, None)
...
def main():
    ...
    for series_name in all_series_to_fix:
        ...
        series_info = query_deepseek_for_series_info(series_name)
