#!/usr/bin/env python3
"""
Comprehensive Performance Test for Manga Lookup Tool
...
def run_performance_test():
    ...
    try:
        ...
        from app_new_workflow import search_series_info, get_volume_info
    ...
    for vol_num in range(1, 6):
        ...
        if volume_info:
            ...
            print(f"   Volume {vol_num}: {vol_time:.2f}s")
        else:
    ...
    # Calculate speedup
    speedup = uncached['total_time'] / cached['total_time'] if cached['total_time'] > 0 else 0
