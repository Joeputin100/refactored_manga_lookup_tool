#!/usr/bin/env python3
"""
Fixed pre-seeding script for manga series cache
Uses correct API method signatures available on EC2
"""
...
from manga_lookup import DeepSeekAPI, GoogleBooksAPI, VertexAIAPI, BookInfo, ProjectState
from bigquery_cache import BigQueryCache


class CachePreSeeder:
    def __init__(self):
        # Initialize APIs and project state
    ...
    def search_series(self, series_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            series_info = self.vertex_api.get_comprehensive_series_info(series_name, self.project_state)
            if series_info:
                self.stats['api_calls'] += 1
                return series_info
            ...
            if volumes_info:
                ...
                if self.cache.enabled:
                    for volume in volumes_info:
                        self.cache.cache_volume_info(series_name, volume['volume_number'], volume)
