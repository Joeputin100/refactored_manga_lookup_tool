#!/usr/bin/env python3
"""Backfill missing metadata using Vertex AI API - Fixed version"""
        ...
        try:
            ...
            if result:
                ...
                if updates:
                    ...
                    # Create proper QueryJobConfig
                    job_config = QueryJobConfig(
                        query_parameters=[
                            QueryJobConfig.QueryParameter(
                                name=key,
