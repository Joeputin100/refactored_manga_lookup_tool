...
class BackfillMonitorApp(App):
    ...
    def update_data(self) -> None:
        ...
        if 'error' not in stats:
            ...
            self.query_one("#desc-progress").query_one(ProgressBar).update(progress=stats['descriptions_progress'])
            self.query_one("#isbn-progress").query_one(ProgressBar).update(progress=stats['isbns_progress'])
            self.query_one("#year-progress").query_one(ProgressBar).update(progress=stats['copyright_progress'])
            self.query_one("#pub-progress").query_one(ProgressBar).update(progress=stats['publishers_progress'])
            self.query_one("#cover-progress").query_one(ProgressBar).update(progress=stats['covers_progress'])
