...
def load_missing_volumes():
    ...
    # Series that should have more volumes than currently cached
    series_to_load = [
    ...
    for series_name, total_volumes in series_to_load:
        try:
            ...
            for volume_num in range(1, total_volumes + 1):
                try:
                    ...
                    book_info = api.get_book_info_by_series_and_volume(
